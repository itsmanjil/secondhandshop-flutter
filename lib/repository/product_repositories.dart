...
class ProductRepository {
  ...
  Future<bool> updateproduct(
      File? file, Product products, String? productid) async {
    return ProductAPI().updateproduct(file, products, productid);
  }
  ...
  // Future<ProductResponse?> myproducts(String userid) async {
  //   return ProductAPI().myproducts(userid);
  // }
}
