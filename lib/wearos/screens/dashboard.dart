...
class WearDashboard extends StatefulWidget {
  @override
  _WearDashboardState createState() => _WearDashboardState();
}
...
class _WearDashboardState extends State<WearDashboard> {
                        ...
                        return Column(
                          children: [
                            ...
                            buildUserInfoDisplay(
                                lstProductCategory?.q[0].name, 'Name'),
                            // buildUserInfoDisplay(user.phone, 'Phone', const EditPhoneFormPage()),
                            buildUserInfoDisplay(
                                lstProductCategory?.q[0].email, 'Email'),
                            // Expanded(
                            //   flex: 2,
  ...
  Widget buildUserInfoDisplay(first, String title) => Padding(
