...
import 'package:second_hand_shop/screens/myproducts/editproducts.dart';
import 'package:second_hand_shop/screens/myproducts/myproducts.dart';

class MyProductDetailPage extends StatefulWidget {
  final ProductCategory productCategory;

  const MyProductDetailPage({required this.productCategory});

  @override
  _MyProductDetailPageState createState() =>
      _MyProductDetailPageState(productCategory);
}
...
class _MyProductDetailPageState extends State<MyProductDetailPage>
  ...
  _MyProductDetailPageState(this.productCategory);
  ...
  _deleteProduct(String? id) async {
    bool isAdded = await ProductRepository().deleteproduct(id);
    if (isAdded) {
  ...
  _displayMessage(bool isAdded) {
    if (isAdded) {
      Navigator.push(
          context, MaterialPageRoute(builder: (context) => const MyProducts()));
      MotionToast.success(
